...
def get_heuristic_solution(trains):
    solution = []
    current_time = 0
    ...
    for i, train in enumerate(trains):
        ...
        op = 0
        train_solution.update({0: {"start": 0, "end": max(train[0]["min_duration"], current_time)}})
        ...
        while op != len(train) - 1:
            ...
            train_solution.update({op: {"start": current_time, "end": current_time + train[op]["min_duration"]}})
